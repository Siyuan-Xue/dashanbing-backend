...
export function ProductPreviewSidebar() {
  ...
  return <aside className="product-preview-sidebar">
 ...
 * Metrics verified from sample-bundle/data/outputs/v3/group_04/{report,summary}.json:
 * shot_stats attempts=4, makes=2; student_ids=4; clip_count=4.
 */
export function ProductPreview({ decorative = false }: { decorative?: boolean }) {
  ...
  return <div className="product-preview" aria-label={decorative ? undefined : t("previewTitle")} aria-hidden={decorative || undefined}>
    ...
    <div className="product-preview-content">
      ...
      <figure className="product-preview-video"><img src={`${previews}quick-phases.webp`} width="1920" height="1080" alt={t("previewModelAlt")} loading={decorative ? "lazy" : "eager"} fetchPriority={decorative ? "low" : "high"}/></figure>

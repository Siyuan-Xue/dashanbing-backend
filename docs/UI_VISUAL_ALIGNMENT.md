...
- GitHub 图标在共享 Icon 中统一为 20px 实心圆底、留白猫形；缩小猫咪占比，保留更厚的圆形背景，页眉、侧栏底栏和首页预览统一使用，深色主题自动使用浅色。
...
GitHub 图标统一缩小到 20px，并独立缩小猫咪轮廓，保留更宽的实心圆底。首页按用户指定语气改写为球场式调侃：主标题“让我看看你打球什么b样”，主按钮“上传，验验货”，能力、示例、行动入口和英文文案同步调整。仍明确五视频输入、后台处理、真实示例数量及 AI 需要原片复核。

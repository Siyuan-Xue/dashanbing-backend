...
def process_action_group(
    ...
    *,
    ...
    if progress_callback:
        progress_callback("ball_tracking")
    ...
    if progress_callback:
        progress_callback("synchronizing")
    ...
    if progress_callback:
        progress_callback("action_recognition")
    ...
    if progress_callback:
        progress_callback("outcome_detection")
